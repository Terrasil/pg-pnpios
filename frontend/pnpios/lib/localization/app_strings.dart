...
class AppStrings {
  ...
  String get noSearchHistory => isPl ? 'Brak historii wyszukiwania.' : 'No search history.';
  String get filtersTitle => isPl ? 'Filtry wyników' : 'Result filters';
  String get clearFiltersButton => isPl ? 'Wyczyść filtry' : 'Clear filters';
  String get authorFilterLabel => isPl ? 'Filtr autora' : 'Author filter';
  String get genreFilterLabel => isPl ? 'Filtr gatunku' : 'Genre filter';
  String get nameFilterLabel => isPl ? 'Filtr nazwy' : 'Name filter';
  String get onlyWithOffersFilter => isPl ? 'Tylko z ofertami i ceną' : 'Only with offers and price';
  String get onlyWithBooksFilter => isPl ? 'Tylko autorzy z książkami' : 'Only authors with books';
